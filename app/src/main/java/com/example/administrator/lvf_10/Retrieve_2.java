...
public class Retrieve_2 extends AppCompatActivity {
    String response = new String();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_retrieve_2);
        ...
        final EditText passwordback_editText = (EditText)findViewById(R.id.passwordback_editText);
        ...
        nbutton.setOnClickListener(new View.OnClickListener() {//下一步键响应
            ...
            public void onClick(View v) {//将验证码进行匹配
                ...
                if(passwordback_editText.getText().toString().equals(response)&&!(passwordback_editText.getText().toString().equals(""))){
                    //  验证码验证成功后跳转
                    Intent intent = new Intent(Retrieve_2.this,Retrieve_3.class);
                    intent.putExtra("Phonenumber",Phonenumber);
                    startActivity(intent);
                }
                else{
                    AlertDialog.Builder normalDialog1 = new AlertDialog.Builder(Retrieve_2.this);
        ...
        tv.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                AlertDialog.Builder normalDialog = new AlertDialog.Builder(Retrieve_2.this);
